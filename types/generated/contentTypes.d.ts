...
export interface ApiAppApp extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    links: Schema.Attribute.Component<'info.link', true>;
...
export interface ApiEducationEducation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Period: Schema.Attribute.Component<'info.period', false>;
    degree: Schema.Attribute.String;
    Item: Schema.Attribute.Component<'objects.item', false>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    item: Schema.Attribute.Component<'objects.item', false>;
    color: Schema.Attribute.Component<'objects.color', false>;
    Period: Schema.Attribute.Component<'info.period', false>;
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    Item: Schema.Attribute.Component<'objects.item', false>;
    color: Schema.Attribute.Component<'objects.color', true>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
